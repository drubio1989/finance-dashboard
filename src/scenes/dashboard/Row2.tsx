    ...
    <>
      <DashboardBox gridArea="d">
        <BoxHeader
          ...
          sideText="top line represents revenue, bottom line represents expenses"
        />
      ...
      <DashboardBox  gridArea="e">
        ...
        <FlexBetween mt='0.25rem' gap='1.5rem' pr='1rem'>
          ...
          <Box ml='-0.7rem' flexBasis='40%' textAlign='center'>
            ...
            <Typography variant='h6'>Finance goals fo the campaign that is desired</Typography>
          </Box>
          <Box flexBasis='40%'>
            <Typography variant='h5'>Losses in Sales</Typography>
